    ...
    <div className="container-fluid">
            ...
            <li className={activeMenu === "commonsetting" ? "active" : ""}>
              <Tooltip title="CommonSetting" placement="right">
                <Link
                  to=""
                  className="tptp"
                  onClick={() => setActiveMenu("commonsetting")}
                >
      ...
      <section id="content">
        ...
        <main>
          ...
          {activeMenu === "commonsetting" && <CommonSetting />}
          {activeMenu === "banner" && <ManageBanner />}
          {activeMenu === "blogs" && <ManageBanner />}
          {activeMenu === "users" && <ManageUsers />}
          {activeMenu === "leads" && <LeadsEnquiry />}
        </main>
        {/* <!-- MAIN --> */}
      </section>
      {/* <!-- CONTENT --> */}
